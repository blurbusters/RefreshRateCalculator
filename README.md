...
* Measuring refresh rate on Macs/iPads is accurate only up to 120Hz (if you disable "Prefer Page Rendering Updates near 60fps" setting)
* Measuring refresh rate on iPhones is accurate only to 60Hz
